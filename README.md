...
An automation, routing, and parallel delegation layer for the Claude Code CLI, built and validated on Termux/Android. It deterministic-gates user prompts into task archetypes to inject runtime guidance directives and runs parallel Kimi Code CLI agents in isolated git worktrees with schema validation and salvage capabilities.

## What It Is
`auto-selector` provides two main pillars to optimize task execution in Claude Code:
1. **Task-Gate Hook ([task-gate.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/task-gate.sh)):** A deterministic parser running on `UserPromptSubmit` that matches prompts against 11 archetypes to inject a single process directive. It includes Cyrillic morphology matching, effort overlay, session deduplication, and a telemetry loop.
2. **Delegation Launcher ([kimi_parallel.sh](file:///data/data/com.termux/files/home/auto-selector/scripts/kimi_parallel.sh)):** A parallel wrapper for the Kimi Code CLI that manages task briefs using git-worktree isolation, timeout protection, and output validation.
...
- **Continuous Evaluation:** A telemetry loop ([skill-telemetry.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/skill-telemetry.sh)) correlates gate directives with actual skill invokes (`cache/skill-telemetry.jsonl`). Rules not followed are pruned.

## Repository Layout
| Directory | Purpose | Key Contents |
| :--- | :--- | :--- |
| [docs/](file:///data/data/com.termux/files/home/auto-selector/docs) | Design specifications and snaps | specs, [settings.json.snapshot](file:///data/data/com.termux/files/home/auto-selector/docs/settings.json.snapshot) |
| [hooks/](file:///data/data/com.termux/files/home/auto-selector/hooks) | Claude Code CLI hook scripts | [task-gate.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/task-gate.sh), [skill-telemetry.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/skill-telemetry.sh), [state-reinject.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/state-reinject.sh), [log-rotate.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/log-rotate.sh) |
| [research/](file:///data/data/com.termux/files/home/auto-selector/research) | Pipeline studies and sweeps | [kimi-selector-analysis.md](file:///data/data/com.termux/files/home/auto-selector/research/kimi-selector-analysis.md), [web-routing-hooks-sweep.md](file:///data/data/com.termux/files/home/auto-selector/research/web-routing-hooks-sweep.md) |
| [scripts/](file:///data/data/com.termux/files/home/auto-selector/scripts) | Kimi launchers and helpers | [kimi_parallel.sh](file:///data/data/com.termux/files/home/auto-selector/scripts/kimi_parallel.sh), [validate_output.py](file:///data/data/com.termux/files/home/auto-selector/scripts/validate_output.py), [brief_lib.sh](file:///data/data/com.termux/files/home/auto-selector/scripts/brief_lib.sh) |
| [tests/](file:///data/data/com.termux/files/home/auto-selector/tests) | Regression test suites | [test-task-gate.sh](file:///data/data/com.termux/files/home/auto-selector/tests/test-task-gate.sh), [test-kimi-parallel.sh](file:///data/data/com.termux/files/home/auto-selector/tests/test-kimi-parallel.sh) |
...
1. **Task-Gate Hook ([task-gate.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/task-gate.sh)):** Детерминиран парсер, стартиращ при `UserPromptSubmit`, който сравнява заявките с 11 архетипа, за да инжектира една процесна директива. Включва съпоставяне на морфологията на кирилица, наслагване на интензивност на усилията (effort overlay: `HIGH`/`LOW`), премахване на дублирането в сесията и телеметричен цикъл.
2. **Delegation Launcher ([kimi_parallel.sh](file:///data/data/com.termux/files/home/auto-selector/scripts/kimi_parallel.sh)):** Паралелна обвивка (wrapper) за Kimi Code CLI, която управлява описанията на задачите (briefs) чрез изолация с git-worktree, защита срещу увисване (timeout) и валидиране на изходните данни.
...
- **Непрекъсната оценка:** Телеметричният цикъл ([skill-telemetry.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/skill-telemetry.sh)) съпоставя куките на филтъра (gate directives) с действително извиканите умения (actual skill invokes) в `cache/skill-telemetry.jsonl`. Правилата, които не се следват, се премахват.

## Структура на хранилището
| Директория | Предназначение | Ключево съдържание |
| :--- | :--- | :--- |
| [docs/](file:///data/data/com.termux/files/home/auto-selector/docs) | Дизайнерски спецификации и снимки | specs, [settings.json.snapshot](file:///data/data/com.termux/files/home/auto-selector/docs/settings.json.snapshot) |
| [hooks/](file:///data/data/com.termux/files/home/auto-selector/hooks) | Hook скриптове за Claude Code CLI | [task-gate.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/task-gate.sh), [skill-telemetry.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/skill-telemetry.sh), [state-reinject.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/state-reinject.sh), [log-rotate.sh](file:///data/data/com.termux/files/home/auto-selector/hooks/log-rotate.sh) |
| [research/](file:///data/data/com.termux/files/home/auto-selector/research) | Проучвания на процесите и обзори | [kimi-selector-analysis.md](file:///data/data/com.termux/files/home/auto-selector/research/kimi-selector-analysis.md), [web-routing-hooks-sweep.md](file:///data/data/com.termux/files/home/auto-selector/research/web-routing-hooks-sweep.md) |
| [scripts/](file:///data/data/com.termux/files/home/auto-selector/scripts) | Kimi стартери и помощни програми | [kimi_parallel.sh](file:///data/data/com.termux/files/home/auto-selector/scripts/kimi_parallel.sh), [validate_output.py](file:///data/data/com.termux/files/home/auto-selector/scripts/validate_output.py), [brief_lib.sh](file:///data/data/com.termux/files/home/auto-selector/scripts/brief_lib.sh) |
| [tests/](file:///data/data/com.termux/files/home/auto-selector/tests) | Регресионни тестови пакети | [test-task-gate.sh](file:///data/data/com.termux/files/home/auto-selector/tests/test-task-gate.sh), [test-kimi-parallel.sh](file:///data/data/com.termux/files/home/auto-selector/tests/test-kimi-parallel.sh) |
